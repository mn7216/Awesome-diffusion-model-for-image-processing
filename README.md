...
**Purpose**: This is an SR-oriented fork of the original repo, since that is my hobby. I found that the original markdown table was, at times, a bit unwieldy to use for my case, so I have created an HTML version with sorting and added more links. 

**Contributors for the original Repo**：
